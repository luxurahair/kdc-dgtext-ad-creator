import os, re, tempfile, subprocess, sys, traceback
...
@app.get("/version")
def version():
    # juste pour confirmer que Render roule la bonne version
    return {"has_sticker_to_ad": True, "debug_traceback": True}
...
def generate(job: Job):
    try:
        ...
        # retourne les 2000 derniers caractères du traceback
